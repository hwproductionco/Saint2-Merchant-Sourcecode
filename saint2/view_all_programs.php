...
<div class="row-fluid">						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-ok text-success"></i> <span class="text-success">Active Campaigns</span></h4>
									<span class="tools">
		   ...
		   //print_r($parse_depreciations_array['response']['depreciations']['depreciation']);
                                 ...
                                 <?php if($parse_array_user_info['response']['user']['user_permissions']['deactivate_campaign'] == 'Yes'){ ?>
                                    <li><a href="#myModal1" data-toggle="modal"><i class="icon-off"></i> Deactivate</a></li>
                                   <?php } ?>
                               ...
                               <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
										<div class="modal-header">
											...
											<h3 id="myModalLabel2">Deactivate</h3>
										</div>
                    ...
                    <div class="row-fluid">
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-off text-error"></i> <span class="text-error">Deactive Campaigns</span></h4>
									<span class="tools">
									...
									<table class="table table-striped table-hover" id="deactive_campaign">
										<thead>
											<tr>
												...
												<th>Type</th>
												<th>Campaign ID</th>
												<!--th style="width:120px;">Reactivate</th>
		   ...
		   //print_r($parse_depreciations_array['response']['depreciations']['depreciation']);
                                 ...
                                 <?php if($parse_array_user_info['response']['user']['user_permissions']['activate_campaign'] == 'Yes'){ ?>
                                    <li><a href="#myModal2" data-toggle="modal"><i class="icon-ok"></i> Activate</a></li>
                                   <?php } ?> 
                                    <?php if($parse_array_user_info['response']['user']['user_permissions']['delete_campaign'] == 'Yes'){ ?>
                                    <li><a href="#myModal3" data-toggle="modal"><i class="icon-trash"></i> Delete</a></li>
                                   <?php } ?>
                               ...
                               <div id="myModal2" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											<h3 id="myModalLabel2">Activate</h3>
										</div>
										<div class="modal-body scroller">
