<div class="row-fluid">
					<div class="span12">
                     ...
                     <div class="span4 responsive">
                     	<div><strong>Account Name:</strong><br /><?php echo $parse_array['response']['account']['biz_name'];?></div>
                        <div><strong>Account ID:</strong><br /><?php echo $parse_array['response']['account']['account_id'];?></div>
                     </div>
                     
                     <div class="span4 responsive">
                     	<div><strong>Support Phone Number:</strong><br /><?php if(!empty($parse_array['response']['account']['contact_phone'])){ echo $parse_array['response']['account']['contact_phone'];}else {echo '';}?></div>
                        <div><strong>Support Email:</strong><br /><a href="<?php echo $parse_array['response']['account']['contact_email'];?>"><?php echo $parse_array['response']['account']['contact_email'];?></a></div>
                     </div>
