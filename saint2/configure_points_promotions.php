...
<div class="row-fluid">
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><?php echo $_REQUEST['camp_name'];?>: Configure Points Campaign Promotion</h4>
									<span class="tools">
       ...
       <input type="hidden" name="promo_id" value="<?php echo $promo_id;?>" />
       						 <div class="control-group">
                                 <label class="control-label" >Multiply or Add</label>
                                 <div class="controls">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Promotion Description</label>
                                 <div class="controls">
                               ...
                               <div class="control-group">
                                 <label class="control-label" for="input1">By how Much</label>
                                 <div class="controls">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Promotion ID</label>
                                 <div class="controls">
                                    <input type="text" class="input-medium" id="input1" value="<?php if(!empty($parse_promotions_array['response']['promotions']['promotion']['promo_custom_id'])){ echo $parse_promotions_array['response']['promotions']['promotion']['promo_custom_id'];}else {echo '';}?>" /> Optional
                                 </div>
                               ...
                               <div class="form-actions">
                                 ...
                                 <button type="button" class="btn" onclick="redir(2)">Discard</button>
                              </div>      
       ...
       <input type="hidden" name="promo_id" value="<?php echo $promo_id;?>" />
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Promotion ID</label>
                                 <div class="controls">
                                    <input type="text" class="input-medium" id="input1" value="<?php echo $promo['promo_custom_id'];?>" /> Optional
                                 </div>
                                 <input type="hidden" name="camp_id" value="<?php echo $camp_id;?>" />
                                    <input type="hidden" name="page_id" value="1" />
                              </div> 
                    ...
                    <div class="row-fluid">
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4>Campaign Name: Configure Points Campaign Promotion</h4>
									<span class="tools">
       ...
       <form action="add_promotion.php" class="form-horizontal" method="get">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Promotion ID</label>
                                 <div class="controls">
                                    <input type="text" class="input-medium" id="input1" /> Optional
                                 </div>
                                 <input type="hidden" name="camp_id" value="<?php echo $camp_id;?>" />
                                    <input type="hidden" name="page_id" value="1" />
                              </div> 
