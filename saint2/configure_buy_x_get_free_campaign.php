...
<div class="row-fluid">
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><?php echo $parse_campaigns_array['response']['campaigns']['campaign']['name'];?>: Configure Buy X, Get 1 Free Campaign</h4>
									<span class="tools">
  ...
  <ul class="nav nav-tabs tabs-left responsive">
    ...
    <li><a href="#pane3" data-toggle="tab">Promotions</a></li>
    <?php } ?>
  </ul>
      ...
      <h5>Current Promotions</h5>
       ...
       <tr>
        ...
        <?php if($parse_array_user_info['response']['user']['user_permissions']['edit_buyx_items'] == 'Yes'){ ?><td><button type="submit" class="btn-small btn-info" onclick="window.location.href='configure_buy_x_promotion.php?promotion_id=<?php echo $promotion['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1&camp_name=<?php echo $parse_campaigns_array['response']['campaigns']['campaign']['name'];?>'"><i class="icon-pencil"></i> Edit</button></td><?php } ?>
                <?php if($parse_array_user_info['response']['user']['user_permissions']['delete_buyx_items'] == 'Yes'){ ?><td><a href="delete_buy_x_item.php?promotion_id=<?php echo $promotion['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1" onclick="return confirm('Are you sure?')"><button type="submit" class="btn-small btn-danger"><i class="icon-trash"></i> Delete</button></a></td><?php } ?>
        </tr>
        ...
        <?php if($parse_array_user_info['response']['user']['user_permissions']['add_buyx_items'] == 'Yes'){ ?><div style="margin-top:15px;"> <button type="submit" class="btn btn-success" onclick="window.location.href='configure_buy_x_promotion.php?camp_id=<?php echo $camp_id;?>'"><i class="icon-plus"></i> Add</button> </div><?php } ?>
				...
				foreach($parse_campaigns_array['response']['campaigns']['campaign'] as $camp)
				{
                    ...
                    <div class="row-fluid">
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><?php echo $camp['name'];?>: Configure Buy X, Get 1 Free Campaign</h4>
									<span class="tools">
