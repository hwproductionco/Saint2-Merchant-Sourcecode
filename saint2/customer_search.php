...
<input class="span6 " type="text" name="cust_value<?php echo $rand;?>" id="cust_value<?php echo $rand;?>"><span id="hid<?php echo $rand;?>"> <button type="button" class="btn btn-small btn-success" onclick="add_field(<?php echo $rand;?>)" ><i class="icon-plus"></i> Add Field</button></span>
<!--span class="help-inline">Some hint here</span-->
                              ...
                              <div class="form-actions" style="padding-top:35px;">
                                 <button type="submit" class="btn btn-primary"><i class="icon-play"></i> Run Report</button>
