		...
		<div id="body">
			...
			<div class="container-fluid">
                ...
                <!-- BEGIN QUICK SEARCH FORM -->
					...
					<form class="navbar-search" id="search_form" style="width:100% !important;" action="view_all_advocates.php" method="post">
						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-group"></i> View All Customers</h4>
									<span class="tools">
