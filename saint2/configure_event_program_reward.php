...
<div class="row-fluid">
       ...
       <form action="edit_points_rewards.php" class="form-horizontal" method="post">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Number of Events:</label>
                                 <div class="controls">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Description of reward obtained when
the number of events specifed is attained.</label>
                                 <div class="controls">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Reward ID:</label>
                                 <div class="controls">
