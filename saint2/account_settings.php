						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-user"></i> Account Info</h4>
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="b_name">Business Name</label>
                                 <div class="controls">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="cntry">Country</label>
                                 <div class="controls">
                              ...
                              <div class="control-group">
                              	<label class="control-label" for="c_symbol">Currency Symbol</label>
                                <div class="controls">
                                <select class="span6" data-placeholder="Choose Your Currency" tabindex="1" name="c_symbol" id="c_symbol">
								 ...
								 <div class="control-group">
                              	<label class="control-label" for="time_zone">Timezone Selector</label>
                                <div class="controls">
                              ...
                              <div class="form-actions">
                                 <button type="button" class="btn btn-success" onclick="submit_form()">Save Changes</button>
                                 <button type="button" class="btn" onClick="resetme()">Cancel</button>
                              </div>
