...
<div class="row-fluid">
  ...
  <ul class="nav nav-tabs tabs-left responsive">
    ...
    <li><a href="#pane3" data-toggle="tab">Reward Levels</a></li>
    ...
    <div id="pane3" class="tab-pane">
      ...
      <h5>Current Reward Levels</h5>
       ...
       <tr>
        ...
        <td><button type="submit" class="btn-small btn-info" onclick="window.location.href='configure_earn_per_event_reward.php?camp_id=<?php echo $camp_id;?>&page_id=1&camp_name=<?php echo $parse_campaigns_array['response']['campaigns']['campaign']['name'];?>'"><i class="icon-pencil"></i> Edit</button></td>
       ...
       <div style="margin-top:15px;"> <button type="submit" class="btn btn-success" onclick="window.location.href='configure_earn_per_event_reward.php?camp_id=<?php echo $camp_id;?>'"><i class="icon-plus"></i> Add</button> </div>
    ...
    <div id="pane3" class="tab-pane">
      ...
      <h5>Current Reward Levels</h5>
       ...
       <tr>
        ...
        <td><button type="submit" class="btn-small btn-info" onclick="window.location.href='configure_earn_per_event_reward.php?camp_id=<?php echo $camp_id;?>&page_id=1&camp_name=<?php echo $camp['name'];?>'"><i class="icon-pencil"></i> Edit</button></td>
<!--<td><a href="delete_reward.php?reward_id=<?php //echo $parse_rewards_array['response']['rewards']['reward']['id'];?>&camp_id=<?php //echo $camp_id;?>&page_id=1" onclick="return confirm('Are you sure?')"><button type="button" class="btn-small btn-danger" ><i class="icon-trash"></i> Delete</button></a></td>-->
        </tr>
