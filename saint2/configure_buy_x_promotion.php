...
<div class="row-fluid">				
            			<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><?php echo $_REQUEST['camp_name'];?>: Configure Promotion</h4>
									<span class="tools">
       ...
       <form action="edit_buy_x_promotion.php" class="form-horizontal" method="post">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Service, Product or Category</label>
                                 <div class="controls">
                               ...
                               <div class="control-group">
                                 ...
                                 <div class="controls">
                                    <input type="text" class="input-medium" id="promo_id1" name="promo_id1" value=""  /> Optional
                                 </div>
                              </div> 
                              
                               <div class="control-group">
                                 <label class="control-label" for="input1">How Many Until Next Is Free</label>
                                 <div class="controls">
                               ...
                               <div class="form-actions">
                                 ...
                                 <button type="button" class="btn" onclick="redir(7)">Discard</button>
                              </div>      
       ...
       <form action="edit_buy_x_promotion.php" class="form-horizontal" method="post">
					...
					<div class="row-fluid">				
            			<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4>Campaign Name: Configure Promotion</h4>
									<span class="tools">
       ...
       <form action="edit_buy_x_promotion.php" class="form-horizontal" method="post">
         <div class="control-group">
                               ...
                               <div class="control-group">
                                 <label class="control-label" for="input1">Promotion ID</label>
                                 <div class="controls">
                                    <input type="text" class="input-medium" id="promo_id1" name="promo_id1" /> Optional
                                 </div>
                              </div> 
      ...
      <?php } else{ ?>
       <form action="add_buy_x_promotion.php" class="form-horizontal" method="get">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">Promotion ID</label>
                                 <div class="controls">
                                    <input type="text" class="input-medium" id="input1" name="promo_id" /> Optional
                                 </div>
                              </div> 
