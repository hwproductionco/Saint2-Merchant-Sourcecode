...
<li><a href="#pane4" data-toggle="tab">Recurring Fee</a></li>
    ...
    <div id="pane1" class="tab-pane active">
     ...
     <form action="edit_point_campaign.php" class="form-horizontal" method="post">
                              <div class="control-group">
                                ...
                                <div class="control-group">
                                 <label class="control-label" >Link to Points Program</label>
                                 <div class="controls">
                               ...
                               <div class="form-actions">
                                 ...
                                 <button type="button" class="btn" onclick="redir(8)">Discard</button>
                              </div>      
    ...
    <div id="pane2" class="tab-pane">
     <h4>Depreciation</h4>
      ...
      <h5>Current Depreciation Levels</h5>
       ...
       <?php if($parse_array_user_info['response']['user']['user_permissions']['add_depreciation'] == 'Yes'){ ?><div style="margin-top:15px;"> <button type="submit" class="btn btn-success" onclick="window.location.href='configure_gift_card_depreciation.php?camp_id=<?php echo $camp_id;?>'"><i class="icon-plus"></i> Add</button> </div><?php } ?>
    ...
    <h4>Recurring Fee</h4>
      ...
      <h5>Current Recurring Fee</h5>
       ...
       <tr>
        ...
        <td><a href="delete_fee.php?fee_id=<?php echo $parse_fees_array['response']['fees']['fee']['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1" onclick="return confirm('Are you sure?')"><button type="button" class="btn-small btn-danger" ><i class="icon-trash"></i> Delete</button></a></td>
        </tr>
        <?php } else {
        ...
        <td><button type="submit" class="btn-small btn-info" onclick="window.location.href='configure_gift_card_fees.php?fee_id=<?php echo $fee['id'];?>&camp_name=<?php echo $parse_campaigns_array['response']['campaigns']['campaign']['name'];?>&camp_id=<?php echo $camp_id;?>&page_id=1'"><i class="icon-pencil"></i> Edit</button></td>
        <td><a href="delete_fee.php?fee_id=<?php echo $fee['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1" onclick="return confirm('Are you sure?')"><button type="button" class="btn-small btn-danger" ><i class="icon-trash"></i> Delete</button></a></td>
        </tr>
        <?php }}} ?>
        </table></div>
       <div style="margin-top:15px;"> <button type="submit" class="btn btn-success" onclick="window.location.href='configure_gift_card_fees.php?camp_id=<?php echo $camp_id;?>'"><i class="icon-plus"></i> Add</button> </div>
   ...
   <div id="pane4" class="tab-pane">
    <h4>Recurring Fee</h4>
      ...
      <h5>Current Recurring Fee</h5>
       ...
       <tr>
       	<td>Every <?php echo $parse_fees_array['response']['fees']['fee']['interval'].' '.$parse_fees_array['response']['fees']['fee']['interval_type'],' deduct $'.$parse_fees_array['response']['fees']['fee']['amount'].' for non-activity.';?></td>
        <td><button type="submit" class="btn-small btn-info" onclick="window.location.href='configure_gift_card_fees.php?fee_id=<?php echo $parse_fees_array['response']['fees']['fee']['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1&camp_name=<?php echo $camps['name'];?>'"><i class="icon-pencil"></i> Edit</button></td>
        <td><a href="delete_fee.php?fee_id=<?php echo $parse_fees_array['response']['fees']['fee']['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1" onclick="return confirm('Are you sure?')"><button type="button" class="btn-small btn-danger" ><i class="icon-trash"></i> Delete</button></a></td>
        </tr>
        <?php } else {
			foreach($parse_fees_array['response']['fees']['fee'] as $fee)
		...
		?> 
         <tr>
       	<td>Every <?php echo $fee['interval'].' '.$fee['interval_type'],' deduct $'.$fee['amount'].' for non-activity.';?></td>
        <td><button type="submit" class="btn-small btn-info" onclick="window.location.href='configure_gift_card_fees.php?fee_id=<?php echo $fee['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1&camp_name=<?php echo $camps['name'];?>'"><i class="icon-pencil"></i> Edit</button></td>
        <td><a href="delete_fee.php?fee_id=<?php echo $fee['id'];?>&camp_id=<?php echo $camp_id;?>&page_id=1" onclick="return confirm('Are you sure?')"><button type="button" class="btn-small btn-danger" ><i class="icon-trash"></i> Delete</button></a></td>
        </tr>
        <?php }}} ?>
        </table></div>
       <div style="margin-top:15px;"> <button type="submit" class="btn btn-success" onclick="window.location.href='configure_gift_card_fees.php?camp_id=<?php echo $camp_id;?>&page_id=1'"><i class="icon-plus"></i> Add</button> </div>
