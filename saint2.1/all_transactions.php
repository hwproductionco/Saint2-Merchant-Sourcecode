						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-bar-chart"></i>  <?php echo $lang['All'].' '.$lang['Transactions'];?></h4>
                                ...
                                <form class="form-horizontal" action="all_transactions_report.php" method="post" id="all_trans_report">
