<div id="header" class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<!-- BEGIN LOGO -->
				<a class="brand" href="account_settings.php">
				Welcome, <?php
			...
			<ul>
				...
				<li class="has-sub">
					...
					<ul class="sub">
						...
						<?php if($parse_array_user_info['response']['user']['user_permissions']['import_customers'] == 'Yes') { ?><li><a class="" href="import_customers.php"><?php echo $lang['manage_import_customers'];?></a></li><?php } ?>
						<?php if($parse_array_user_info['response']['user']['user_permissions']['import_transactions'] == 'Yes') { ?><li><a class="" href="import_transactions.php">Import <?php echo $lang['Transactions'];?></a></li><?php } ?></ul>
