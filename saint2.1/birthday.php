						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-bar-chart"></i>  <?php echo $lang['report_customer_birthday_header'];?></h4>
                                ...
                                <form class="form-horizontal" action="birthday_report_results.php" method="post" id="all_trans_report">
