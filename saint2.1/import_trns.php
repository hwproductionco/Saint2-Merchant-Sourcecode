...
{
	header('Location: import_transactions.php?msg='.$import_array['response']['error']);
}
else
{
	if(isset($_POST['email']))
	{
		...
		$to = $parse_array['response']['account']['contact_email'];
				$subject = 'Transactions Import Confirmation';
				$message = '<html><body>
			<p>All Selected Transactions are Imported</p>
			</body></html>';
		...
		header('Location: import_transactions.php?msg="Transactions Imported Successfully"');
}
