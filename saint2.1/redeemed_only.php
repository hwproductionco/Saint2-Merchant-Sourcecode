						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-bar-chart"></i>  <?php echo $lang['report_audits_redeemed_only'];?></h4>
                                ...
                                <form class="form-horizontal" action="redeemed_only_transaction_report.php" method="post" id="all_trans_report">
