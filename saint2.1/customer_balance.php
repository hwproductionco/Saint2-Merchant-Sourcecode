						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-bar-chart"></i> <?php echo $lang['report_balances_header'];?></h4>
                                ...
                                <form class="form-horizontal" action="customer_balance_report.php" method="post" id="all_trans_report">
