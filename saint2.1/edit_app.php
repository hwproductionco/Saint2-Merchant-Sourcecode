	...
	setSelectedIndex(document.getElementById('lang'),"<?php echo $parse_array_user_info['response']['user']['user_language'];?>");
						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-tablet"></i>  Edit App</h4>
                                ...
                                <div class="span12">
                                <!-- BEGIN FORM -->
                                <form action="update_app.php" class="form-horizontal" method="post" id="edit_user_form">
                              ...
                              <div class="control-group">
                                 <label class="control-label" for="input1">App Name</label>
                                 <div class="controls">
				...
				<option value="">Need More? Contact Us.</option>
                              ...
                              <div class="form-actions">
                                 <button type="button" class="btn btn-success" onClick="submit_add_user(2)"><i class="icon-plus icon-white"></i> Create New App</button>
