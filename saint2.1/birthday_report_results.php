			...
			<div class="container-fluid">
						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-group"></i> <?php echo $lang['report_customer_birthday_header'];?></h4>
									<span class="tools">
				...
				?>
											<tr class="odd gradeX" id="tr1">
												...
												<td><?php  echo $parse_all_trans_array['response']['customer']['custom_date'];?></td>
												<td><?php if(!empty($parse_all_trans_array['response']['customer']['first_name']) && !empty($parse_all_trans_array['response']['customer']['last_name'])){ echo $parse_all_trans_array['response']['customer']['last_name'].' '.$parse_all_trans_array['response']['customer']['last_name'];}?></td>
												<td class="hidden-phone"><?php echo $parse_all_trans_array['response']['customer']['card_number'];?></td>
												...
												<td class="hidden-phone center"><?php if(!empty($parse_all_trans_array['response']['customer']['email'])){ echo $parse_all_trans_array['response']['customer']['email'];}?></td>
					...
					else
					{
						...
						foreach($parse_all_trans_array['response']['customer'] as $all_transactions)
						{
                            ...
                            <tr class="odd gradeX" id="tr<?php echo $count;?>">
												...
												<td><?php  echo $all_transactions['custom_date'];?></td>
												...
												<td class="hidden-phone"><?php echo $all_transactions['card_number'];?></td>
												<td class="hidden-phone"><?php if(!empty($all_transactions['phone'])){ echo $all_transactions['phone'];}?></td>
												<td class="hidden-phone center"><?php if(!empty($all_transactions['email'])){ echo $all_transactions['email'];}?></td>
												<td class="hidden-phone"></td>
