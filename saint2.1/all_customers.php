...
<div class="row-fluid">
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-bar-chart"></i>  <?php echo $lang['report_all_customers'];?></h4>
                                ...
                                <form class="form-horizontal" action="all_customers_report.php" method="post" id="all_trans_report">
                              ...
                              <div class="control-group">
                                 <div class="controls">
                                    ...
                                    <label class="checkbox">
                                    <input type="checkbox" class="group-checkable" data-set=".checkboxes" /><?php echo $lang['label_Select'].' / '.$lang['nav_deselect_all'];?>
                                    </label>
                  ...
                  <input type="checkbox" id="inlineCheckbox1" class="checkboxes" name="case[]" value="<?php echo $campaign['id'];?>" /><?php echo $campaign['name'];?></label>
                  <?php }}} ?>
