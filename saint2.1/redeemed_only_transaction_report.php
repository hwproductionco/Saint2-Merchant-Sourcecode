			...
			<div class="container-fluid">
						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-group"></i>  <?php echo $lang['report_audits_redeemed_only'];?></h4>
									<span class="tools">
				...
				?>
											<tr class="odd gradeX" id="tr1">
												...
												<td><?php if(!empty($parse_all_trans_array['response']['transaction']['date'])){  echo $parse_all_trans_array['response']['transaction']['date'];/*$list .= $parse_all_trans_array['response']['transaction']['date'].',';} else { $list .=',';*/}?></td>
												<td><?php if(!empty($parse_all_trans_array['response']['transaction']['user_id'])){ echo $parse_all_trans_array['response']['transaction']['user_id']; /*$list .= $parse_all_trans_array['response']['transaction']['user_id'].',';}else { $list .=',';*/}?></td>
												<td class="hidden-phone"><?php if(!empty($parse_all_trans_array['response']['transaction']['authorization'])){ echo $parse_all_trans_array['response']['transaction']['authorization'];/*$list .= $parse_all_trans_array['response']['transaction']['authorization'].',';}else { $list .=',';*/}?></td>
										...
										foreach($parse_campaigns_array['response']['campaigns']['campaign'] as $campaign)
										{
											if($campaign['id'] == $parse_all_trans_array['response']['transaction']['campaign_id']){
											   if(!empty($campaign['name'])){	echo $campaign['name'];/*$list .= $campaign['name'].',';}else { $list .=',';*/}
												...
												<td class="hidden-phone center"><?php if(!empty($parse_campaigns_array['response']['campaigns']['campaign']['name'])){ echo $parse_campaigns_array['response']['campaigns']['campaign']['name'];/*$list .= $parse_campaigns_array['response']['campaigns']['campaign']['name'].',';}else { $list .=',';*/}?></td>
												...
												<td class="hidden-phone"><?php if(!empty($parse_all_trans_array['response']['transaction']['customer']['first_name']) && !empty($parse_all_trans_array['response']['transaction']['customer']['last_name'])){ echo $parse_all_trans_array['response']['transaction']['customer']['first_name'].' '.$parse_all_trans_array['response']['transaction']['customer']['last_name'];/*$list .= $parse_all_trans_array['response']['transaction']['first_name'].' '.$parse_all_trans_array['response']['transaction']['last_name'].',),';}else { $list .=',),';*/}?></td>
