						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-bar-chart"></i>  <?php echo $lang['report_missing_header'];?></h4>
                                ...
                                <form class="form-horizontal" action="missing_customers_report.php" method="post" id="all_trans_report">
                              ...
                              <div class="control-group">
                               	<label class="control-label"><strong>Missing For<br />(<?php echo $lang['label_Number'].' of '.$lang['days'];?>)</strong></label>
                                 <div class="controls">
                                    <input type="text" class="span6" id="freq" name="day" />
                                 </div><span class="help-inline" id="error1" style="color:#F00"></span>
                              </div>
                            ...
                            <div class="controls">
                              <select class="span6" data-placeholder="Choose a Category" name="redeem" tabindex="1">
